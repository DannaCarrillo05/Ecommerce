...
@section('content')
    <div class="row">
        <div class="ms-3">
            <h3 class="h4 font-weight-bolder mb-0">Dashboard Admin Page Unab Shop</h3>
            <p class="mb-4">
            ...
            <div class="card">
                <div class="card-header p-2 ps-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <div
                            class="icon icon-md icon-shape bg-gradient-dark shadow-dark border-radius-lg text-center shadow">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                <div class="card-header p-2 ps-3">
                    <div class="d-flex justify-content-between">
                        <div>
                            <p class="text-capitalize mb-0 text-sm">Ads Views</p>
